 ...
 * Custom by kokeksibir, https://github.com/ytlabs/ng-slim-scroll
 * Edited by Cecep
 */

angular.module('ngSlimScroll', [])
    .directive('slimScroll', ['$window', '$document', '$timeout', '$rootScope', function ($window, $document, $timeout, $rootScope) {
        ...
        return {
            ...
            link: function ($scope, element) {
                ...
                //Custom: when state change the scroll is re init. dependency: ui-router
